  ...
  return (
    <div className='p-4'>
      <form className='m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
       ...
       <textarea rows={2} value={data.description} id="" className='bg-slate-200 p-1 my-1 resize-none' name='description' onChange={handleOnChange}></textarea>
       <button className='bg-orange-500 hover:bg-green-600 text-white text-lg font-medium my-2 drop-shadow' >Save</button>
      </form>
